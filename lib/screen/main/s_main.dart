...
import 'package:app_base/screen/main/tab/tab_item.dart';
import 'package:app_base/screen/main/tab/tab_navigator.dart';
import 'package:app_base/screen/main/write/d_write_todo.dart';
...
class MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: _handleBackPressed,// 화면을 좌에서 우로 쓸었을때 back에 대한 event발생시 callback
      child: Scaffold(
